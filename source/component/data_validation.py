...
class DataValidation:
    ...
    def initiate_data_validation(self, key):
        ...
        if key == 'predict':
            ...
            data = read_csv_from_s3(self.utility_config.aws_bucket_name,
                                    self.utility_config.predict_file_path + '/' + self.utility_config.predict_file)
            ...
            upload_artifact_to_s3(data, self.utility_config.predict_file, self.utility_config.predict_dv_file_path,
